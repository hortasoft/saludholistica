...
--
-- Dumping data for table `schedule_odonto`
--

LOCK TABLES `schedule_odonto` WRITE;
/*!40000 ALTER TABLE `schedule_odonto` DISABLE KEYS */;
/*!40000 ALTER TABLE `schedule_odonto` ENABLE KEYS */;
UNLOCK TABLES;
