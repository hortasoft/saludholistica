...
--
-- Dumping data for table `waiting_odonto`
--

LOCK TABLES `waiting_odonto` WRITE;
/*!40000 ALTER TABLE `waiting_odonto` DISABLE KEYS */;
/*!40000 ALTER TABLE `waiting_odonto` ENABLE KEYS */;
UNLOCK TABLES;
